...
from MVWarpedMFSI.user_parameter import user_parameter
from MVWarpedMFSI.vb import inference
from MVWarpedMFSI import evaluation
from MVWarpedMFSI import aux_variable

def run_MVWarpedMFSI(option,obs,up,mat_mask_train,mat_mask_test,is_latent_space=False):
    
    user_param = user_parameter(n_ranks = up.K,n_folds=up.n_folds,R=up.R,max_iters=up.max_iters,convergence_threshold=up.convergence_threshold,n_processes=1)
